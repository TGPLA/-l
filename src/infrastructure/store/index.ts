import type { Book, Question, Settings, SyncData } from '../types';
...
export const storage = {
  ...
  addBook(book: Omit<Book, 'id' | 'createdAt' | 'questionCount'>): Book {
  ...
  updateBookQuestionCount(bookId: string): void {
    ...
    this.updateBook(bookId, { questionCount: questions.length });
  },
